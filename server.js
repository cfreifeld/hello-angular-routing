...
const app = express();
app.use(express.static(__dirname + '/dist/hello-routing'));
...
app.post('/api/users', upload.single("myFile"), createUser);
...
app.get('/*', function(req,res) {
  res.sendFile(path.join(__dirname + '/dist/hello-routing/index.html'));
});
